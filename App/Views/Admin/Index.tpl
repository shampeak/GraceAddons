...
<a class="shambox" rel="/admin/index/operate">股票操作</a>

<a class="shambox" rel="/admin/index/log">操作记录</a>
...
<a class="formact" relid="{$value['uid']}" tag="/admin/index/delete" confirm="确定?">删除</a>
